...
@Autonomous(name = "ZenithBlueFar", group = "Mark2")
public class ZenithBlueFar extends LinearOpMode {
    ...
    private static final double FAR_AIM_POSITION = 0.91;
    ...
    private static final Pose START_POSE = pose(62.147, 7.772, START_HEADING_DEG);

    private static final Pose PRELOAD_LAUNCH = point(56.565, 17.277);
    private static final double PRELOAD_LAUNCH_HEADING_DEG = 180.0;

    private static final Pose ROW3_ALIGN = point(44.256, 35.316);
    private static final double ROW3_ALIGN_HEADING_DEG = 180.0;
    private static final Pose ROW3_INTAKE = point(17.647, 35.637);
    private static final double ROW3_INTAKE_HEADING_DEG = 180.0;
    private static final Pose ROW3_LAUNCH = point(52.605, 17.326);
    private static final double ROW3_LAUNCH_HEADING_DEG = 176.0;

    private static final Pose CORNER_ALIGN = point(17.95, 21.35);
    private static final double CORNER_ALIGN_HEADING_DEG = 215.0;
    private static final Pose CORNER_INTAKE = point(11.628, 12.419);
    private static final double CORNER_INTAKE_HEADING_DEG = 180.0;
    private static final Pose CORNER_LAUNCH = point(52.753, 17.107);
    private static final double CORNER_LAUNCH_HEADING_DEG = 180.0;

    private static final Pose OVERFLOW1_START = point(18.549, 11.633);
    private static final double OVERFLOW1_START_HEADING_DEG = 145.0;
    private static final Pose OVERFLOW1_INTAKE = point(12.744, 35.521);
    private static final double OVERFLOW1_INTAKE_HEADING_DEG = 100.0;
    private static final Pose OVERFLOW1_LAUNCH = point(52.628, 17.228);
    private static final double OVERFLOW1_LAUNCH_HEADING_DEG = 180.0;

    private static final Pose OVERFLOW2_START = point(18.386, 11.786);
    private static final double OVERFLOW2_START_HEADING_DEG = 145.0;
    private static final Pose OVERFLOW2_INTAKE = point(12.786, 35.549);
    private static final double OVERFLOW2_INTAKE_HEADING_DEG = 100.0;
    private static final Pose OVERFLOW2_LAUNCH = point(52.614, 17.460);
    private static final double OVERFLOW2_LAUNCH_HEADING_DEG = 180.0;

    private static final Pose PARK = point(44.456, 18.093);
    private static final double PARK_HEADING_DEG = 180.0;
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("ZenithBlueFar ready");
