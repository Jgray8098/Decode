...
@Autonomous(name = "ZenithRedClose", group = "Mark2")
public class ZenithRedClose extends LinearOpMode {
    ...
    // ===== Path Tuning =====
    // Red side mirrors ZenithBlueClose across the field centerline:
    // x = 144 - blueX, y = blueY, heading = 180 - blueHeading.
    private static final double START_HEADING_DEG = 217.0;
    ...
    private static final Pose GATE_ALIGN = point(118.144, 57.540);
    private static final double GATE_ALIGN_HEADING_DEG = 35.0;
    private static final Pose GATE_INTAKE = point(128.0, 57.628);
    private static final double GATE_INTAKE_HEADING_DEG = 25.0;
    private static final Pose GATE_CLEAR = point(122.000, 60.000);
    private static final double GATE_CLEAR_HEADING_DEG = 320.0;
    private static final Pose GATE1_LAUNCH = point(88.451, 85.135);

    private static final Pose GATE2_LAUNCH = point(88.667, 85.523);

    private static final Pose GATE3_LAUNCH = point(88.703, 85.502);

    private static final double GATE_LAUNCH_HEADING_DEG = 320.0;
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("ZenithRedClose ready");
